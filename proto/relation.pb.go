...
var file_proto_relation_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x1a, 0x10, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x22, 0x8e, 0x01, 0x0a, 0x1e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x72, 0x65,
	...
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x91, 0x01, 0x0a, 0x26, 0x64, 0x6f, 0x75, 0x79, 0x69,
	...
	0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xf4, 0x02, 0x0a, 0x0b, 0x52,
	0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x72, 0x76, 0x12, 0x6d, 0x0a, 0x16, 0x64, 0x6f,
	...
	0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x77, 0x0a, 0x16, 0x64, 0x6f, 0x75,
	0x79, 0x69, 0x6e, 0x5f, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x66, 0x6f, 0x6c,
	0x6c, 0x6f, 0x77, 0x12, 0x2d, 0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x64,
	...
	0x73, 0x65, 0x12, 0x7d, 0x0a, 0x18, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x72, 0x65, 0x6c,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x12, 0x2f,
	0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	0x5f, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77,
...
var file_proto_relation_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_proto_relation_proto_depIdxs = []int32{
	...
	0, // 2: relation.RelationSrv.douyin_relation_action:input_type -> relation.douyin_relation_action_request
	2, // 3: relation.RelationSrv.douyin_relation_follow:input_type -> relation.douyin_relation_follow_list_request
	4, // 4: relation.RelationSrv.douyin_relation_follower:input_type -> relation.douyin_relation_follower_list_request
	1, // 5: relation.RelationSrv.douyin_relation_action:output_type -> relation.douyin_relation_action_response
	3, // 6: relation.RelationSrv.douyin_relation_follow:output_type -> relation.douyin_relation_follow_list_response
	5, // 7: relation.RelationSrv.douyin_relation_follower:output_type -> relation.douyin_relation_follower_list_response
...
type RelationSrvClient interface {
	...
	//关注列表
	DouyinRelationFollow(ctx context.Context, in *DouyinRelationFollowListRequest, opts ...grpc.CallOption) (*DouyinRelationFollowListResponse, error)
	//粉丝列表
	DouyinRelationFollower(ctx context.Context, in *DouyinRelationFollowerListRequest, opts ...grpc.CallOption) (*DouyinRelationFollowerListResponse, error)
}
...
func (c *relationSrvClient) DouyinRelationAction(ctx context.Context, in *DouyinRelationActionRequest, opts ...grpc.CallOption) (*DouyinRelationActionResponse, error) {
	out := new(DouyinRelationActionResponse)
	err := c.cc.Invoke(ctx, "/relation.RelationSrv/douyin_relation_action", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationSrvClient) DouyinRelationFollow(ctx context.Context, in *DouyinRelationFollowListRequest, opts ...grpc.CallOption) (*DouyinRelationFollowListResponse, error) {
	out := new(DouyinRelationFollowListResponse)
	err := c.cc.Invoke(ctx, "/relation.RelationSrv/douyin_relation_follow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationSrvClient) DouyinRelationFollower(ctx context.Context, in *DouyinRelationFollowerListRequest, opts ...grpc.CallOption) (*DouyinRelationFollowerListResponse, error) {
	out := new(DouyinRelationFollowerListResponse)
	err := c.cc.Invoke(ctx, "/relation.RelationSrv/douyin_relation_follower", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RelationSrvServer interface {
	...
	//关注列表
	DouyinRelationFollow(context.Context, *DouyinRelationFollowListRequest) (*DouyinRelationFollowListResponse, error)
	//粉丝列表
	DouyinRelationFollower(context.Context, *DouyinRelationFollowerListRequest) (*DouyinRelationFollowerListResponse, error)
}
...
func (*UnimplementedRelationSrvServer) DouyinRelationAction(context.Context, *DouyinRelationActionRequest) (*DouyinRelationActionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DouyinRelationAction not implemented")
}
func (*UnimplementedRelationSrvServer) DouyinRelationFollow(context.Context, *DouyinRelationFollowListRequest) (*DouyinRelationFollowListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DouyinRelationFollow not implemented")
}
func (*UnimplementedRelationSrvServer) DouyinRelationFollower(context.Context, *DouyinRelationFollowerListRequest) (*DouyinRelationFollowerListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DouyinRelationFollower not implemented")
}
...
func _RelationSrv_DouyinRelationAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DouyinRelationActionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RelationSrvServer).DouyinRelationAction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/relation.RelationSrv/DouyinRelationAction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelationSrvServer).DouyinRelationAction(ctx, req.(*DouyinRelationActionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RelationSrv_DouyinRelationFollow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DouyinRelationFollowListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RelationSrvServer).DouyinRelationFollow(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/relation.RelationSrv/DouyinRelationFollow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelationSrvServer).DouyinRelationFollow(ctx, req.(*DouyinRelationFollowListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RelationSrv_DouyinRelationFollower_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DouyinRelationFollowerListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RelationSrvServer).DouyinRelationFollower(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/relation.RelationSrv/DouyinRelationFollower",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelationSrvServer).DouyinRelationFollower(ctx, req.(*DouyinRelationFollowerListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RelationSrv_DouyinRelationAction_Handler,
		},
		{
			MethodName: "douyin_relation_follow",
			Handler:    _RelationSrv_DouyinRelationFollow_Handler,
		},
		{
			MethodName: "douyin_relation_follower",
			Handler:    _RelationSrv_DouyinRelationFollower_Handler,
		},
	},
