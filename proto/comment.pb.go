...
var file_proto_comment_proto_rawDesc = []byte{
	...
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x74,
	...
	0x44, 0x61, 0x74, 0x65, 0x22, 0x4e, 0x0a, 0x1b, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x63,
	...
	0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xda, 0x01, 0x0a, 0x0a, 0x43,
	0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x72, 0x76, 0x12, 0x68, 0x0a, 0x15, 0x64, 0x6f, 0x75,
	...
	0x6e, 0x73, 0x65, 0x12, 0x62, 0x0a, 0x13, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x63, 0x6f,
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x24, 0x2e, 0x63, 0x6f, 0x6d,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x63, 0x6f, 0x6d, 0x6d,
	0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x25, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69,
...
var file_proto_comment_proto_depIdxs = []int32{
	...
	0, // 3: comment.CommentSrv.douyin_comment_action:input_type -> comment.douyin_comment_action_request
	3, // 4: comment.CommentSrv.douyin_comment_list:input_type -> comment.douyin_comment_list_request
	1, // 5: comment.CommentSrv.douyin_comment_action:output_type -> comment.douyin_comment_action_response
	4, // 6: comment.CommentSrv.douyin_comment_list:output_type -> comment.douyin_comment_list_response
...
func (c *commentSrvClient) DouyinCommentAction(ctx context.Context, in *DouyinCommentActionRequest, opts ...grpc.CallOption) (*DouyinCommentActionResponse, error) {
	out := new(DouyinCommentActionResponse)
	err := c.cc.Invoke(ctx, "/comment.CommentSrv/douyin_comment_action", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentSrvClient) DouyinCommentList(ctx context.Context, in *DouyinCommentListRequest, opts ...grpc.CallOption) (*DouyinCommentListResponse, error) {
	out := new(DouyinCommentListResponse)
	err := c.cc.Invoke(ctx, "/comment.CommentSrv/douyin_comment_list", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCommentSrvServer) DouyinCommentAction(context.Context, *DouyinCommentActionRequest) (*DouyinCommentActionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DouyinCommentAction not implemented")
}
func (*UnimplementedCommentSrvServer) DouyinCommentList(context.Context, *DouyinCommentListRequest) (*DouyinCommentListResponse, error) {
...
func _CommentSrv_DouyinCommentAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DouyinCommentActionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommentSrvServer).DouyinCommentAction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comment.CommentSrv/DouyinCommentAction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentSrvServer).DouyinCommentAction(ctx, req.(*DouyinCommentActionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CommentSrv_DouyinCommentList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DouyinCommentListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommentSrvServer).DouyinCommentList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comment.CommentSrv/DouyinCommentList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentSrvServer).DouyinCommentList(ctx, req.(*DouyinCommentListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _CommentSrv_DouyinCommentAction_Handler,
		},
		{
			MethodName: "douyin_comment_list",
			Handler:    _CommentSrv_DouyinCommentList_Handler,
		},
	},
