...
import (
	api_init2 "douyin-Jacob/cmd/api/comment_api/api_init"
	global2 "douyin-Jacob/cmd/api/comment_api/global"
	router2 "douyin-Jacob/cmd/api/comment_api/router"
...
func main()  {
	...
	if !debug{
		...
		if err==nil{
			global2.ServerConfig.Port=8085 //暂时固定道8087端口。//注意health不成功，可能是端口不空闲。
		}
	}
	//服务注册
