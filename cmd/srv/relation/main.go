...
import (
	...
	relation_init2 "douyin-Jacob/cmd/srv/relation/relation_init"
	service2 "douyin-Jacob/cmd/srv/relation/service"
...
func main()  {
	...
	relation_init2.InitConfig()
	relation_init2.InitDB()
	...
	*Port,_ =utils.GetFreePort()
	...
	proto.RegisterRelationSrvServer(server,&service2.Relation{})
