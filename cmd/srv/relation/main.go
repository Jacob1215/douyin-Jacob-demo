...
import (
	...
	"douyin-Jacob/cmd/relation/relation_init"
	"douyin-Jacob/cmd/relation/service"
...
func main()  {
	...
	relation_init.InitConfig()
	relation_init.InitDB()
	...
	*Port,_ =utils.GetFreePort()
	...
	proto.RegisterRelationSrvServer(server,&service.Relation{})
