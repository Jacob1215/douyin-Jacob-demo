...
import (
	comment_init2 "douyin-Jacob/cmd/srv/comment/comment_init"
	global2 "douyin-Jacob/cmd/srv/comment/global"
	service2 "douyin-Jacob/cmd/srv/comment/service"
...
func main()  {
	...
	comment_init2.InitConfig()
	comment_init2.InitDB()
	...
	*Port,_ =utils.GetFreePort()
	...
	proto.RegisterCommentSrvServer(server,&service2.Comment{})
